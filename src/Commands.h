...
enum {
    ...
    CmdShowLog = 366, CmdShowPdfInfo = 367, CmdClearHistory = 368,
    CmdReopenLastClosedFile = 369, CmdNextTab = 370, CmdPrevTab = 371,
    CmdNextTabSmart = 372, CmdPrevTabSmart = 373, CmdMoveTabLeft = 374,
    CmdMoveTabRight = 375, CmdSelectNextTheme = 376, CmdToggleFrequentlyRead = 377,
    CmdInvokeInverseSearch = 378, CmdExec = 379, CmdViewWithExternalViewer = 380,
    CmdSelectionHandler = 381, CmdSetTheme = 382, CmdToggleInverseSearch = 383,
    CmdDebugCorruptMemory = 384, CmdDebugCrashMe = 385, CmdDebugDownloadSymbols = 386,
    ...
    CmdScreenshot = 396, CmdCropImage = 397, CmdResizeImage = 398,
    CmdSaveImage = 399, CmdPasteClipboardImage = 400, CmdNone = 401,
